	...
	BEGIN
		...
		BEGIN
			...
			CREATE TABLE dbo.fhsmWaitCategories(
				...
				,CONSTRAINT PK_fhsmWaitCategories PRIMARY KEY(WaitType)
			);
		END;
		...
		BEGIN
			...
			CREATE TABLE dbo.fhsmWaitStatistics(
				...
				,CONSTRAINT PK_WaitStatistics PRIMARY KEY(Id)
			);

			CREATE NONCLUSTERED INDEX NC_fhsmWaitStatistics_TimestampUTC ON dbo.fhsmWaitStatistics(TimestampUTC);
			CREATE NONCLUSTERED INDEX NC_fhsmWaitStatistics_Timestamp ON dbo.fhsmWaitStatistics(Timestamp);
			CREATE NONCLUSTERED INDEX NC_fhsmWaitStatistics_WaitType ON dbo.fhsmWaitStatistics(WaitType);
		END;
