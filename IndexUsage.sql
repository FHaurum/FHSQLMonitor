	...
	BEGIN
		...
		BEGIN
			...
			CREATE TABLE dbo.fhsmIndexUsage(
				...
				,CONSTRAINT PK_fhsmIndexUsage PRIMARY KEY(Id)
			);

			CREATE NONCLUSTERED INDEX NC_fhsmIndexUsage_TimestampUTC ON dbo.fhsmIndexUsage(TimestampUTC);
			CREATE NONCLUSTERED INDEX NC_fhsmIndexUsage_Timestamp ON dbo.fhsmIndexUsage(Timestamp);
			CREATE NONCLUSTERED INDEX NC_fhsmIndexUsage_DatabaseName_SchemaName_ObjectName_IndexName ON dbo.fhsmIndexUsage(DatabaseName, SchemaName, ObjectName, IndexName);
		END;
