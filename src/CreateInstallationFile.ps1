...
Add-Content $outputFile ("SET @installationMsg = 'Install/upgrade FHSQLMonitor in ' + @fhSQLMonitorDatabase + ' to " + $versionNumber + "';")
...
Add-Content $outputFile "			WHERE j.name = @installationJobName"
